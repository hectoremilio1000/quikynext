...
export default function PACIENTEUpdateForm(props) {
  const {
    id: idProp,
    pACIENTE: pACIENTEModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = pACIENTERecord
      ? { ...initialValues, ...pACIENTERecord }
      : initialValues;
    setNombres(cleanValues.nombres);
    setApellidoPaterno(cleanValues.apellidoPaterno);
    setApellidoMaterno(cleanValues.apellidoMaterno);
    setSexo(cleanValues.sexo);
  ...
  const [pACIENTERecord, setPACIENTERecord] = React.useState(pACIENTEModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(PACIENTE, idProp)
        : pACIENTEModelProp;
      setPACIENTERecord(record);
    };
    queryData();
  }, [idProp, pACIENTEModelProp]);
  React.useEffect(resetStateValues, [pACIENTERecord]);
  const validations = {
    nombres: [],
    apellidoPaterno: [],
    apellidoMaterno: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            PACIENTE.copyOf(pACIENTERecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PACIENTEUpdateForm")}
      {...rest}
    >
      <TextField
        label="Nombres"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || pACIENTEModelProp)}
