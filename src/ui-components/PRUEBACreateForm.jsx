...
export default function PRUEBACreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPrecioDescuento(initialValues.precioDescuento);
    setDescripcionCorta(initialValues.descripcionCorta);
    setTiempoEntrega(initialValues.tiempoEntrega);
    setIndicaciones(initialValues.indicaciones);
    setTipoMuestra(initialValues.tipoMuestra);
    setTipoContenedor(initialValues.tipoContenedor);
    setErrors({});
  };
  const validations = {
    nombre: [],
