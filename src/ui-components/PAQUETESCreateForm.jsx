...
export default function PAQUETESCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPrecioTotal(initialValues.precioTotal);
    setErrors({});
  };
  const validations = {
    nombre: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PAQUETES(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PAQUETESCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
