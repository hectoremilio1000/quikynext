...
export default function RESULTADOGENERALCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setResultadoQuimico(initialValues.resultadoQuimico);
    setErrors({});
  };
  const validations = {
    resultadoQuimico: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new RESULTADOGENERAL(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "RESULTADOGENERALCreateForm")}
      {...rest}
    >
      <TextField
