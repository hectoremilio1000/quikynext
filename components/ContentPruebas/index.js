        ...
        <div className='contentInfo' style={{ backgroundColor: "#F8F8FF" }}>
            ...
            <div className="rowQh dFlex" style={{ gap: "20px" }}>
                <div className="blockElement">
                    <img style={{ height: "400px", objectFit: "cover", width: "100%" }} src="https://quikyempresanuevo-storage-03418b58110747-dev.s3.amazonaws.com/public/images/home/quimicasanguinea+copy.jpg" alt="" />
                ...
                <div className="blockElement">
                    <img style={{ height: "400px", objectFit: "cover", width: "100%" }} src="https://quikyempresanuevo-storage-03418b58110747-dev.s3.amazonaws.com/public/images/home/antigeno.jpg" alt="" />
                    ...
                    <p className="contentModel">Prueba rápida para detectar la presencia de COVID-19 en tu cuerpo.</p>
                    <a href="https://wa.me/+5219511028474">
                        <button type="button" className="buttonModel mt-6 mb-6">
                            ¡Reserva ya!
                        </button>
                ...
                <div className="blockElement">
                    <img style={{ height: "400px", objectFit: "cover", width: "100%" }} src="https://quikyempresanuevo-storage-03418b58110747-dev.s3.amazonaws.com/public/images/home/orina.jpg" alt="" />
                    <h1>Ego</h1>
                    <p className="contentModel2">Orina</p>
                    <p className="contentModel3">RESULTADOS EN 2 a 4 horas</p>
                    <p className="contentModel">El examen general de orina es un examen de tu orina el cual se utiliza para revisar signos de algunas condiciones comunes o padecimientos.</p>
                    <a href="https://wa.me/+5219511028474">
                        <button type="button" className="buttonModel mt-6 mb-6">
                            ¡Reserva ya!
                        </button>
